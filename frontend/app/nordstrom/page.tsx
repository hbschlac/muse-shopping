...
export default function NordstromPage() {
  const [products, setProducts] = useState<NordstromProduct[]>([]);
    ...
    async function fetchNordstromProducts() {
      try {
        ...
        if (data.success && data.data.items) {
          ...
          setError('Failed to fetch Nordstrom products');
        }
      } catch (err) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">
              100 products from our Nordstrom collection
            </p>
          </div>
          ...
          {loading && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Loading Nordstrom products...</p>
            </div>
          )}
