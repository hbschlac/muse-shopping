...
export default function ScoopsPage() {
  const [products, setProducts] = useState<ScoopsProduct[]>([]);
    ...
    async function fetchScoopsProducts() {
      try {
        ...
        if (data.success && data.data.items) {
          ...
          setError('Failed to fetch Scoops products');
        }
      } catch (err) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              Scoop's Women's Clothing
            </h1>
            <p className="text-sm text-gray-600">
              100 products from our Scoop's collection
            </p>
          </div>
          ...
          {loading && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Loading Scoop's products...</p>
            </div>
          )}
