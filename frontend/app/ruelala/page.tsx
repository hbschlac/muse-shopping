...
export default function BloomingdalesPage() {
  ...
  useEffect(() => {
    async function fetchBloomingdalesProducts() {
      try {
        // Fetch directly from items API with storeId=128 (Bloomingdales)
        const response = await fetch('http://localhost:3000/api/v1/items?storeId=128&limit=100');
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              Rue La La Women's Clothing
            </h1>
            <p className="text-sm text-gray-600">
              100 products from our Rue La La collection
            </p>
          </div>
          ...
          {loading && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Loading Rue La La products...</p>
            </div>
          )}
